...
class ApiService {
  ...
  Future<Map<String, dynamic>> updateProfile({
    ...
    try {
      ...
      String endpoint;
      switch (role) {
        case UserRole.client: endpoint = '/client/profile'; break;
        case UserRole.driver: endpoint = '/driver/profile'; break;
        case UserRole.admin: endpoint = '/garage-admin/profile'; break;
        case UserRole.superAdmin: endpoint = '/super-admin/profile'; break;
      }
  ...
  Future<Map<String, dynamic>> deleteAccount() async {
    try {
      final response = await _dio.delete('/users/account', options: Options(headers: {'Content-Type': 'application/json'}));
      return _handleResponse(response);
    } catch (e) {
  ...
  Future<Map<String, dynamic>> getUserStats() async {
    try {
      final response = await _dio.get('/users/stats', options: Options(headers: {'Content-Type': 'application/json'}));
      return _handleResponse(response);
    } catch (e) {
  ...
  Future<Map<String, dynamic>> markAsInTransit(String parcelId, {String? location}) async {
    try {
      final response = await _dio.put('/driver/parcels/$parcelId/transit', data: location != null ? {'location': location} : null);
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> markAsArrived(String parcelId, {String? location}) async {
    try {
      final response = await _dio.put('/driver/parcels/$parcelId/arrived', data: location != null ? {'location': location} : null);
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> markAsOutForDelivery(String parcelId, {String? location}) async {
    try {
      final response = await _dio.put('/driver/parcels/$parcelId/out-for-delivery', data: location != null ? {'location': location} : null);
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Parcel> createParcel(Map<String, dynamic> data) async {
    try {
      ...
      String endpoint;
      switch (role) {
        case UserRole.client: endpoint = '/client/parcels/create'; break;
        case UserRole.driver: endpoint = '/driver/parcels/create'; break;
        case UserRole.admin: endpoint = '/garage-admin/parcels/create'; break;
        case UserRole.superAdmin: endpoint = '/super-admin/parcels/create'; break;
      }
      final cleanedData = {
        'receiverName': data['receiverName'],
        'receiverPhone': data['receiverPhone'],
  ...
  Future<List<ParcelEvent>> getParcelEvents(String parcelId) async {
    try {
      ...
      final responseData = _handleResponse(response);
      final dynamic rawEvents = responseData['events'] ?? responseData['data'] ?? [];
      ...
      return eventsData.map((event) {
        ...
        return ParcelEvent(
          ...
          status: ParcelStatus.fromString(json['status']?.toString() ?? 'pending'),
          ...
          metadata: metadata,
          timestamp: parseDate(json['timestamp'] ?? json['createdAt'] ?? json['created_at']) ?? DateTime.now(),
        );
      }).toList();
    } catch (e) {
  ...
  Future<Parcel> updateParcelStatus(String parcelId, String status, {String? location}) async {
    ...
    debugPrint('   location: $location');
      ...
      String endpoint;
      switch (role) {
        case UserRole.client: endpoint = '/client/parcels/$parcelId/status'; break;
        case UserRole.driver: endpoint = '/driver/parcels/$parcelId/status'; break;
        case UserRole.admin: endpoint = '/garage-admin/parcels/$parcelId/status'; break;
        case UserRole.superAdmin: endpoint = '/super-admin/parcels/$parcelId/status'; break;
      }
      final response = await _dio.put(endpoint, data: {'status': status, 'location': location});
      final responseData = _handleResponse(response);
  ...
  Future<Parcel?> getParcelById(String parcelId) async {
    try {
      ...
      String endpoint;
      switch (role) {
        case UserRole.client: endpoint = '/client/parcels/$parcelId'; break;
        case UserRole.driver: endpoint = '/driver/parcels/$parcelId'; break;
        case UserRole.admin: endpoint = '/garage-admin/parcels/$parcelId'; break;
        case UserRole.superAdmin: endpoint = '/super-admin/parcels/$parcelId'; break;
      }
  ...
  Future<Map<String, dynamic>> assignDriverToParcel(String parcelId, String driverId) async {
    try {
      final response = await _dio.put('/garage-admin/parcels/$parcelId/assign-driver', data: {'driverId': driverId});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> getGarageDailyReport(DateTime date) async {
    try {
      final response = await _dio.get('/garage-admin/reports/daily', queryParameters: {'date': date.toIso8601String().split('T').first});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> getGarageMonthlyReport(int year, int month) async {
    try {
      final response = await _dio.get('/garage-admin/reports/monthly', queryParameters: {'year': year, 'month': month});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> exportGarageReport({required String format, DateTime? startDate, DateTime? endDate}) async {
    try {
  ...
  Future<Map<String, dynamic>> bulkAssignDrivers(List<Map<String, String>> assignments) async {
    try {
      final response = await _dio.post('/garage-admin/parcels/bulk-assign', data: {'assignments': assignments});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> updateGarageAdminSuperAdmin({required String adminId, required String garageId}) async {
    try {
      final response = await _dio.put('/super-admin/garage-admins/$adminId', data: {'garageId': garageId});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<List<User>> getAllDriversSuperAdmin() async {
    try {
      final response = await _dio.get('/super-admin/users', queryParameters: {'role': 'driver'});
      final responseData = _handleResponse(response);
      final List<dynamic> usersData = responseData['users'] ?? [];
      return usersData.map((json) => User.fromJson(json as Map<String, dynamic>)).where((user) => user.role == UserRole.driver).toList();
    } catch (e) {
  ...
  Future<Map<String, dynamic>> updateDriverStatusSuperAdmin(String driverId, String status) async {
    try {
      final response = await _dio.patch('/super-admin/users/$driverId/status', data: {'status': status});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> updateDriverDocument({required String type, required String documentUrl}) async {
    try {
      final response = await _dio.put('/driver/documents', data: {'type': type, 'documentUrl': documentUrl});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> getDriverSchedule(DateTime date) async {
    try {
      final response = await _dio.get('/driver/schedule', queryParameters: {'date': date.toIso8601String().split('T').first});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> updateDriverSchedule({required DateTime date, required bool isAvailable}) async {
    try {
      final response = await _dio.post('/driver/schedule', data: {'date': date.toIso8601String().split('T').first, 'isAvailable': isAvailable});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> initiatePayment({required double amount, required String method, String? parcelId, String? phoneNumber}) async {
    try {
  ...
  Future<Map<String, dynamic>> confirmPayment(String paymentId, {String? transactionId}) async {
    try {
      final response = await _dio.post('/payments/$paymentId/confirm', data: {'transactionId': transactionId});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<String?> uploadFile(File file, String type) async {
    ...
    try {
      final formData = FormData.fromMap({
        'file': await MultipartFile.fromFile(file.path, filename: file.path.split('/').last, contentType: MediaType('image', 'jpeg')),
        'type': type,
      });
  ...
  Future<String?> uploadFileFromXFile(XFile file, String type) async {
    try {
      if (kIsWeb) {
        final bytes = await file.readAsBytes();
        final formData = FormData.fromMap({
          'file': MultipartFile.fromBytes(bytes, filename: file.name, contentType: MediaType('image', 'jpeg')),
          'type': type,
        });
        final response = await _dio.post('/upload', data: formData);
        final responseData = _handleResponse(response);
        if (responseData['success'] == true && responseData['url'] != null) return responseData['url'];
        return null;
      } else {
        final formData = FormData.fromMap({
  ...
  Future<String?> uploadProfilePhotoFromFile(dynamic file) async {
    try {
      if (kIsWeb && file is XFile) {
        ...
        final response = await _dio.post('/upload', data: formData, options: Options(headers: {'Content-Type': 'multipart/form-data'}));
        final responseData = _handleResponse(response);
        if (responseData['success'] == true && responseData['url'] != null) return responseData['url'];
        return null;
  ...
  Future<Map<String, dynamic>> updateProfilePhoto(String photoUrl) async {
    try {
      ...
      String endpoint;
      switch (role) {
        case UserRole.client: endpoint = '/client/profile-photo'; break;
        case UserRole.driver: endpoint = '/driver/profile-photo'; break;
        case UserRole.admin: endpoint = '/garage-admin/profile-photo'; break;
        case UserRole.superAdmin: endpoint = '/super-admin/profile-photo'; break;
      }
  ...
  Future<Map<String, dynamic>> uploadAndUpdateProfilePhoto(XFile file) async {
    try {
      ...
      if (photoUrl == null) return {'success': false, 'message': 'Erreur lors de l\'upload'};
  ...
  Future<Map<String, dynamic>> assignVehicleToDriver(String vehicleId, String driverId) async {
    try {
      final response = await _dio.put('/vehicles/$vehicleId/assign', data: {'driverId': driverId});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> updateVehicleStatus(String vehicleId, bool isAvailable) async {
    try {
      final response = await _dio.patch('/vehicles/$vehicleId/status', data: {'isAvailable': isAvailable});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> getDailyReport({required DateTime date}) async {
    try {
      final response = await _dio.get('/super-admin/reports/daily', queryParameters: {'date': date.toIso8601String().split('T').first});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> getYearlyReport({required int year}) async {
    try {
      final response = await _dio.get('/super-admin/reports/yearly', queryParameters: {'year': year});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> exportData({required String type, String? format}) async {
    try {
      final response = await _dio.get('/super-admin/export', queryParameters: {'type': type, 'format': format ?? 'json'});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<String?> exportReport({required String reportType, required String format, DateTime? startDate, DateTime? endDate}) async {
    try {
      final queryParams = <String, dynamic>{'reportType': reportType, 'format': format};
      if (startDate != null) queryParams['startDate'] = startDate.toIso8601String().split('T').first;
      if (endDate != null) queryParams['endDate'] = endDate.toIso8601String().split('T').first;
  ...
  Future<Map<String, dynamic>> updateDriverLocation({required double latitude, required double longitude}) async {
    try {
      final response = await _dio.post('/driver/location', data: {'latitude': latitude, 'longitude': longitude});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> submitRating({required String parcelId, required int rating, String? comment}) async {
    try {
      final response = await _dio.post('/ratings', data: {'parcelId': parcelId, 'rating': rating, 'comment': comment});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> sendSupportMessage({required String subject, required String message, List<String>? attachments}) async {
    try {
      final response = await _dio.post('/support/messages', data: {'subject': subject, 'message': message, 'attachments': attachments});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> verifyIdentity({required String nationalId, required String fullName, required DateTime birthDate}) async {
    try {
  ...
  Future<Map<String, dynamic>> uploadIdentityDocument(File file, String type) async {
    try {
      final formData = FormData.fromMap({'file': await MultipartFile.fromFile(file.path), 'type': type});
  ...
  Future<Map<String, dynamic>> validateCoupon(String code, double amount) async {
    try {
      final response = await _dio.post('/coupons/validate', data: {'code': code, 'amount': amount});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<Map<String, dynamic>> sendMessage({required String receiverId, required String message, String? parcelId}) async {
    try {
      final response = await _dio.post('/messages', data: {'receiverId': receiverId, 'message': message, 'parcelId': parcelId});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
  ...
  Future<List<Map<String, dynamic>>> getMessages(String conversationId, {int page = 1}) async {
    try {
      final response = await _dio.get('/messages/$conversationId', queryParameters: {'page': page});
      final responseData = _handleResponse(response);
      final List<dynamic> messagesData = responseData['messages'] ?? [];
      return messagesData.map((json) => json as Map<String, dynamic>).toList();
    } catch (e) {
  ...
  Future<List<Map<String, dynamic>>> searchParcels({required String query, String? status, DateTime? startDate, DateTime? endDate}) async {
    try {
  ...
  Future<Map<String, dynamic>> registerWebhook({required String url, required List<String> events}) async {
    try {
      final response = await _dio.post('/webhooks', data: {'url': url, 'events': events});
      return _handleResponse(response);
    } catch (e) {
      return {'success': false, 'message': e.toString()};
    }
